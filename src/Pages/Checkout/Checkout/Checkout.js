...
const Checkout = () => {
    // This is checkout page. Bootstrap checkout form is used here.
    return (
                ...
                <div className="row">
                    ...
                    <div className="col-md-8 order-md-1">
                        ...
                        <form className="needs-validation" novalidate>
                            ...
                            <hr className="mb-4" />
                            <Link to="/orderBooked"><button className="btn btn-dark btn-lg btn-block" type="submit">Continue to checkout</button></Link>
                        </form>
                    </div>
                </div>
            </div>
